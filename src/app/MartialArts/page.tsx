...
import EventCarousel from "./MartialArtsEventsCarousel";
...
export default function SingleHub() {
  ...
  const [currentHub, setCurrentHub] = useState(9);
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        const response = await fetch("/api/posts?interest_id=9");
    ...
    <div className={styles.pageContainer}>
      <div className={styles.ForumContainer}>
        <div className={styles.titleContainer}>
          <p className={styles.hubName}>martial arts</p>
        </div>
