...
import EventCarousel from "./TechnoEventsCarousel";
...
export default function SingleHub() {
  ...
  const [currentHub, setCurrentHub] = useState(8);
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        const response = await fetch("/api/posts?interest_id=8");
    ...
    <div className={styles.pageContainer}>
      <div className={styles.ForumContainer}>
        <div className={styles.titleContainer}>
          <p className={styles.hubName}>techno</p>
        </div>
